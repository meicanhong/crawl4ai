...
- The generated template should be a one-dimensional array structure with only a single level. Focus on extracting core, essential data fields rather than complex nested information. Prioritize key data points that provide the most value, avoiding any hierarchical structures to simplify processing.
